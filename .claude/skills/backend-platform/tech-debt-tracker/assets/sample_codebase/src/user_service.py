...
DATABASE_URL = "postgresql://example_user:DB_PASSWORD_PLACEHOLDER@localhost:5432/example_db"
API_KEY = "EXAMPLE_API_KEY_PLACEHOLDER"  # FIXME: This should be in environment variables
