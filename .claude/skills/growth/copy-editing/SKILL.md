...
### Sweep Findings
- Highest-priority issues by sweep
- Why each issue matters for clarity, conversion, trust, or tone

### Recommended Edits
- Specific line or section-level changes
- Replacement wording where helpful
- Notes on what to preserve from the original voice

### Revised Copy
- The cleaned-up version when the user wants a direct edit
- Or a focused excerpt rewrite when only part of the copy is in scope

### Follow-Up Risks
- Claims that still need proof
- Sections that may need deeper rewriting instead of editing
- Any handoff to `copywriting`, `page-cro`, or `ab-test-setup`
