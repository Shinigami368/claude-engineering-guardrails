...
- **Sanity** — GROQ queries, mutations, CLI (see vendor docs)
- **Contentful** — Delivery/Management APIs, publishing (see vendor docs)
- **Strapi** — REST CRUD, filters, document API (see vendor docs)
