...
description: >-
  Debug agent behavior by tracing prompts, tools, memory, and success signals.
---

# Skill: agent-introspection-debugging

## Purpose
Debug agent behavior by tracing prompts, tools, memory, and success signals. Treat this as a narrow pattern card: use it to sharpen one decision surface quickly, then hand back to the broader workflow.

## Use When
- The active question is primarily about: debug agent behavior by tracing prompts, tools, memory, and success signals.
...
## Do Not Use When
- The task needs an end-to-end workflow or multi-step implementation chain. Use `self-improving-agent`.
...
## Focus Checklist
1. Start from the concrete failure mode or waste pattern inside debug agent behavior by tracing prompts, tools, memory, and success signals.
...
4. Escalate to `self-improving-agent` when the problem stops being a narrow review card and becomes an end-to-end workflow.
...
## Related Skills
- Primary broader workflow: `self-improving-agent`
