...
- For FastMCP servers, run `fastmcp inspect`, `fastmcp list --json`, and at
  least one real `fastmcp call` for every new tool before client installation

See language-specific guides for detailed testing approaches and quality checklists.

#### 3.3 Runtime Contract Gates

Before connecting a server to Claude Code, Claude Desktop, Cursor, or an HTTP
client, apply the runtime contract gates in
`references/runtime-contract-gates.md`. Use them to verify
tool/resource/prompt boundaries, transport choice, secrets handling, FastMCP
smoke tests, and compatibility expectations.
...
- [Runtime Contract Gates](./references/runtime-contract-gates.md) - integration checklist for:
  - tool/resource/prompt surface selection
  - FastMCP inspect/list/call smoke testing
  - client installation boundaries
  - contract compatibility without project changelog machinery
