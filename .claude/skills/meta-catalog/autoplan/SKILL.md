...
name: autoplan
description: >-
  Run a compact product, design, engineering, and DX review sequence before implementation.
---

# Skill: autoplan

## Purpose
Run a compact product, design, engineering, and DX review sequence before implementation. Treat this as a narrow pattern card: use it to sharpen one decision surface quickly, then hand back to the broader workflow.

## Use When
- The active question is primarily about: run a compact product, design, engineering, and DX review sequence before implementation.
...
- The main risk has shifted to an adjacent concern outside this card. Use `plan-eng-review`.
- The user only wants generic best practices with no repo, product, or workflow context.

## Focus Checklist
1. Reduce run a compact product, design, engineering, and DX review sequence before implementation to an explicit entry condition, exit condition, and owner.
...
- Adjacent boundary: `plan-eng-review`
