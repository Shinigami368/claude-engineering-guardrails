...
name: gate-taxonomy
description: >-
  Classify preflight, revision, escalation, abort, and verification gates for agentic work.
---

# Skill: gate-taxonomy

## Purpose
Classify preflight, revision, escalation, abort, and verification gates for agentic work. Treat this as a narrow pattern card: use it to sharpen one decision surface quickly, then hand back to the broader workflow.

## Use When
- The active question is primarily about: classify preflight, revision, escalation, abort, and verification gates for agentic work.
...
## Focus Checklist
1. Reduce classify preflight, revision, escalation, abort, and verification gates for agentic work to an explicit entry condition, exit condition, and owner.
