...
description: >-
  Create slash commands that orchestrate repeatable workflows without overloading active context.
---

# Skill: command-development

## Purpose
Create slash commands that orchestrate repeatable workflows without overloading active context. Treat this as a narrow pattern card: use it to sharpen one decision surface quickly, then hand back to the broader workflow.

## Use When
- The active question is primarily about: create slash commands that orchestrate repeatable workflows without overloading active context.
...
- The main risk has shifted to an adjacent concern outside this card. Use `skill-development`.
- The user only wants generic best practices with no repo, product, or workflow context.

## Focus Checklist
1. Map the current repo surface for create slash commands that orchestrate repeatable workflows without overloading active context before proposing a new abstraction or directory shape.
...
- Adjacent boundary: `skill-development`
