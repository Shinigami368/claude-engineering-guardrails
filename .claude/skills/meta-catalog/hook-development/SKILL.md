...
description: >-
  Create lifecycle hooks with fast execution, clear failure behavior, and safe IO boundaries.
---

# Skill: hook-development

## Purpose
Create lifecycle hooks with fast execution, clear failure behavior, and safe IO boundaries. Treat this as a narrow pattern card: use it to sharpen one decision surface quickly, then hand back to the broader workflow.

## Use When
- The active question is primarily about: create lifecycle hooks with fast execution, clear failure behavior, and safe IO boundaries.
...
## Focus Checklist
1. Map the current repo surface for create lifecycle hooks with fast execution, clear failure behavior, and safe IO boundaries before proposing a new abstraction or directory shape.
