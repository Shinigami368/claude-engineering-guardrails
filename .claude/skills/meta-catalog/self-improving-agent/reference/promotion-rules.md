...
When to promote a learning from knowledge files to the project's rule system (CLAUDE.md or `.claude/rules/`).
...
- **Credentials or secrets** — never store in any knowledge file

### Don't duplicate:
- If CLAUDE.md already says "Use pnpm", don't also keep it in knowledge files
