...
description: >-
  Create focused subagents with scoped tools, clear routing triggers, and non-overlapping roles.
---

# Skill: agent-development

## Purpose
Create focused subagents with scoped tools, clear routing triggers, and non-overlapping roles. Treat this as a narrow pattern card: use it to sharpen one decision surface quickly, then hand back to the broader workflow.

## Use When
- The active question is primarily about: create focused subagents with scoped tools, clear routing triggers, and non-overlapping roles.
...
## Focus Checklist
1. Map the current repo surface for create focused subagents with scoped tools, clear routing triggers, and non-overlapping roles before proposing a new abstraction or directory shape.
