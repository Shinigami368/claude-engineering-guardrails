...
description: >-
  Review and implement database migrations with rollback, data safety, and deploy ordering.
---

# Skill: database-migrations

## Purpose
Review and implement database migrations with rollback, data safety, and deploy ordering. Treat this as a narrow pattern card: use it to sharpen one decision surface quickly, then hand back to the broader workflow.

## Use When
- The active question is primarily about: review and implement database migrations with rollback, data safety, and deploy ordering.
...
## Do Not Use When
- The task needs an end-to-end workflow or multi-step implementation chain. Use `postgres-patterns`.
...
## Focus Checklist
1. Review review and implement database migrations with rollback, data safety, and deploy ordering with rollback, sequencing, and blast radius in view.
...
4. Escalate to `postgres-patterns` when the change becomes a full implementation lane.
...
## Related Skills
- Primary broader workflow: `postgres-patterns`
