...
description: >-
  Evaluate liquid-glass visual choices with accessibility, readability, and performance constraints.
---

# Skill: liquid-glass-design

## Purpose
Evaluate liquid-glass visual choices with accessibility, readability, and performance constraints. Treat this as a narrow pattern card: use it to sharpen one decision surface quickly, then hand back to the broader workflow.

## Use When
- The active question is primarily about: evaluate liquid-glass visual choices with accessibility, readability, and performance constraints.
...
- The main risk has shifted to an adjacent concern outside this card. Use `design-system`.
- The user only wants generic best practices with no repo, product, or workflow context.

## Focus Checklist
1. Ground evaluate liquid-glass visual choices with accessibility, readability, and performance constraints in user task, readability, and responsive behavior instead of visual trend-chasing.
...
- Adjacent boundary: `design-system`
