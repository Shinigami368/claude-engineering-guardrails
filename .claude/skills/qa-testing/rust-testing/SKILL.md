...
name: rust-testing
description: >-
  Plan Rust unit, integration, property, and cargo-based quality checks.
---

# Skill: rust-testing

## Purpose
Plan Rust unit, integration, property, and cargo-based quality checks. Treat this as a narrow pattern card: use it to sharpen one decision surface quickly, then hand back to the broader workflow.

## Use When
- The active question is primarily about: plan Rust unit, integration, property, and cargo-based quality checks.
...
## Focus Checklist
1. Favor cargo-native unit/integration tests, async/runtime discipline, and property tests only where invariants justify them.
...
## Evidence To Collect
- cargo test command, runtime mode, and the invariant the tests must protect
