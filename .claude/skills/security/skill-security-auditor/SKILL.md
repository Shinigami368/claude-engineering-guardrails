...
## Repository-Level Scan Gates

When a requested review covers a full repository, pull request, hook set, CI
workflow, or infrastructure surface, pair this skill's static skill checks with
[references/repo-security-scan-gates.md](references/repo-security-scan-gates.md).
Use those gates to keep the review scoped, secret-redacted, evidence-based, and
clear about dependency or runtime limits.
